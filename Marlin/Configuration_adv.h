...
//#define CODEPENDENT_XY_HOMING
  ...
  #define BLTOUCH_DELAY 250 //AWL_ABL_SPEED_CHANGE
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping //AWL_CHANGE
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor //AWL_CHANGE
  #endif
#endif
